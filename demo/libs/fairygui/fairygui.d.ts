...
declare module fgui {
    class PackageItem {
        ...
        hasAsset(): Object;
        load(): Object;
        loadAsync(cb: fgui.Handler): void;
...
declare module fgui {
    ...
    class UIPackage {
        ...
        private _customId;
        private _sprites;
        _dependencies: Array<PackageDependency>;
        private _branches;
        _branchIndex: number;
        ...
        HasAssets(item: PackageItem): boolean;
        getItemAsset(item: PackageItem): Object;
        getItemAssetAsync(item: PackageItem, onComplete: Handler): void;
